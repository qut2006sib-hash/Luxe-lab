...
const menuItems = [
  { icon: ClipboardList, label: "طلبات التحاليل", path: "/" },
  { icon: Users, label: "المرضى", path: "/patients" },
  { icon: TestTubes, label: "دليل التحاليل", path: "/catalog" },
...
function isMenuPathActive(currentPath: string, menuPath: string) {
  return menuPath === "/"
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  <span className="font-semibold tracking-tight truncate text-lg">
                    LUXE Lab
                  </span>
                </div>
              ) : null}
